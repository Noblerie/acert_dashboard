...
export type GetTeamAggregateType<T extends AggregateTeamArgs> = {
  [P in keyof T]: P extends 'count' ? number : GetTeamAggregateScalarType<T[P]>
}

export type GetTeamAggregateScalarType<T extends any> = {
  [P in keyof T]: P extends keyof TeamAvgAggregateOutputType ? TeamAvgAggregateOutputType[P] : never
}
...
export type TeamSelect = {
  name?: boolean
  owner_id?: boolean
  user_id?: boolean | FindManyUserArgs
  id?: boolean
  createdAt?: boolean
  updatedAt?: boolean
}
...
export interface TeamDelegate {
  ...
  **/
   ...
   * const teamWithNameOnly = await prisma.team.findMany({ select: { name: true } })
   * 
  **/
...
export declare class Prisma__TeamClient<T> implements Promise<T> {
  ...
  user_id<T extends FindManyUserArgs = {}>(args?: Subset<T, FindManyUserArgs>): CheckSelect<T, Promise<Array<User>>, Promise<Array<UserGetPayload<T>>>>;
...
export type TeamWhereInput = {
  ...
  user_id?: UserListRelationFilter
  id?: number | IntFilter
...
export type UserCreateInput = {
  ...
  name: string
  phone_number: string
  teams?: TeamCreateManyWithoutUser_idInput
}
...
export type UserUpdateInput = {
  ...
  teams?: TeamUpdateManyWithoutUser_idInput
}
...
export type TeamCreateInput = {
  ...
  user_id?: UserCreateManyWithoutTeamsInput
}

export type TeamUpdateInput = {
  name?: string | StringFieldUpdateOperationsInput
  owner_id?: number | IntFieldUpdateOperationsInput
  createdAt?: Date | string | DateTimeFieldUpdateOperationsInput
  updatedAt?: Date | string | DateTimeFieldUpdateOperationsInput
  user_id?: UserUpdateManyWithoutTeamsInput
}
...
export type TeamCreateManyWithoutUser_idInput = {
  create?: Enumerable<TeamCreateWithoutUser_idInput>
...
export type TeamUpdateManyWithoutUser_idInput = {
  create?: Enumerable<TeamCreateWithoutUser_idInput>
  connect?: Enumerable<TeamWhereUniqueInput>
  set?: Enumerable<TeamWhereUniqueInput>
  disconnect?: Enumerable<TeamWhereUniqueInput>
  delete?: Enumerable<TeamWhereUniqueInput>
  update?: Enumerable<TeamUpdateWithWhereUniqueWithoutUser_idInput>
  updateMany?: Enumerable<TeamUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<TeamScalarWhereInput>
  upsert?: Enumerable<TeamUpsertWithWhereUniqueWithoutUser_idInput>
}

export type UserCreateManyWithoutTeamsInput = {
  create?: Enumerable<UserCreateWithoutTeamsInput>
...
export type TeamCreateWithoutUser_idInput = {
  name: string
  owner_id: number
  createdAt?: Date | string
  updatedAt?: Date | string
...
export type TeamUpdateWithWhereUniqueWithoutUser_idInput = {
  where: TeamWhereUniqueInput
  data: TeamUpdateWithoutUser_idDataInput
}
...
export type TeamUpsertWithWhereUniqueWithoutUser_idInput = {
  where: TeamWhereUniqueInput
  update: TeamUpdateWithoutUser_idDataInput
  create: TeamCreateWithoutUser_idInput
}
...
export type TeamUpdateWithoutUser_idDataInput = {
  name?: string | StringFieldUpdateOperationsInput
  owner_id?: number | IntFieldUpdateOperationsInput
  createdAt?: Date | string | DateTimeFieldUpdateOperationsInput
  updatedAt?: Date | string | DateTimeFieldUpdateOperationsInput
...
export type UserUpdateWithoutTeamsDataInput = {
  email?: string | StringFieldUpdateOperationsInput
  name?: string | StringFieldUpdateOperationsInput
  phone_number?: string | StringFieldUpdateOperationsInput
}
